...
def fuel_tank():
    ...
    # What is likely broken given observed behavior?
    print("Probabilities of faults given evidence:")
    print_conditional_probability(net, {"DT": "true"}, evidence)
    print_conditional_probability(net, {"EM": "true"}, evidence)
    print_conditional_probability(net, {"FTL": "true"}, evidence)
